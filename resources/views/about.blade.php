...
<section class="pt-24">
    <div class="container">
        <div class="gap-2 mx-auto lg:grid lg:grid-cols-2 pt-8 mb-4">
            <div>
                <img class="w-[450x] h-[300px] mx-auto lg:ml-16 rounded-lg shadow-xl lg:w-[550px] lg:h-[400px] " src="/img/about-us2.jpg" alt="">
            </div>
            <div class="ml-5">
                <h1 class="mt-5 uppercase font-extrabold text-primary text-3xl lg:text-4xl text-center mb-2">Perjalanan Kami</h1>
                <p class="text-md lg:text-lg mt-5 text-secondary mx-4">Dengan hanya satu ruang periksa dan tim medis yang terdiri dari beberapa dokter umum dan perawat yang berdedikasi, Klinik Aurelia Medika didirikan pada tahun 1995 oleh
                </p>
                <p class="text-md lg:text-lg mb-7 text-secondary mx-4"> <span class="text-secondary font-bold">Wildan Fauzan ST.</span>, seorang Programmer berpengalaman yang memiliki visi untuk menyediakan layanan kesehatan berkualitas tinggi dan holistik bagi masyarakat setempat. Dengan satu misi yang kuat untuk memberikan perawatan yang peduli dan menyeluruh, Klinik Aurelia Medika sejak itu telah menjadi tempat utama bagi pasien yang mencari perawatan kesehatan yang berfokus pada pasien.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="pb-20 pt-16 ">
    ...
    <div class="flex-wrap items-center justify-center text-center">
        ...
        <p class="font-medium mt-5 text-secondary text-md lg:text-lg mx-4">Aplikasi berbasis web ini diajukan untuk memenuhi tugas besar mata kuliah Praktikum Web</p>
        <p class="font-medium  text-secondary text-md lg:text-lg mx-4">Berikut adalah anggota tim yang mengembangkan aplikasi ini</p>
