<footer class="bg-dark pt-24 pb-12">
    ...
    <div class="flex flex-wrap px-12 lg:px-16">
        ...
        <div class="w-full  mb-12 md:w-1/4 lg:px-16">
            ...
            <ul class="text-slate-300">
                <li>
                    <a href="/antrian" class="inline-block text-base hover:text-primary mb-3">Ambil Antrian</a>
                </li>
        </div>
        <div class="w-full mb-12 md:w-1/4 lg:px-16">
    ...
    <div class="w-full pt-10 border-t border-slate-700">
        <div class="flex items-center justify-center mb-5">
            <!-- instagram -->
          <a href="instagram.com" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white">
            ...
            <!-- facebook -->
            <a href="facebook.com" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white">
            ...
            <!-- X -->
            <a href="twitter.com" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white">
            ...
            <!-- Tiktok -->
            <a href="tiktok.com" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white">
        ...
        <p class="font-medium text-xs text-slate-500 text-center">©️ Copy Right <span class=" text-white">Aurelia Medika</span>. All Right Reserved</p>
    </div>
</div>
</footer>
