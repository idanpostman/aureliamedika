    ...
    <div class="flex flex-wrap px-12 lg:px-16">
        ...
        <div class="w-full  mb-12 md:w-1/4 lg:px-16">
            ...
            <ul class="text-slate-300">
                <li>
                    <a href="#" class="inline-block text-base hover:text-primary mb-3">Ambil Antrian</a>
                </li>
        </div>
        <div class="w-full mb-12 md:w-1/4 lg:px-16">
            ...
            <ul class="text-slate-300">
                <li>
                    <a href="#" class="inline-block text-base hover:text-primary mb-3">Poli Umum</a>
                </li>
                <li>
                    <a href="#" class="inline-block text-base hover:text-primary mb-3">Poli Gigi</a>
                </li>
                <li>
                    <a href="#" class="inline-block text-base hover:text-primary mb-3">Poli THT</a>
                </li>
            </ul>
        </div>
        <div class="w-full mb-12 md:w-1/4 lg:px-16">
            ...
            <ul class="text-slate-300">
                ...
                <li>
                    <a href="#portfolio" class="inline-block text-base hover:text-primary mb-3">Our Doctor</a>
                </li>
                <li>
